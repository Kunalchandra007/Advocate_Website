...
import vivekchandra from '../assets/vivekchandra.jpg';
...
function App() {
  ...
  // Rotating text phrases for About section
  const rotatingPhrases = [
    'Best Advocate in Delhi High Court',
    'Civil Litigation Lawyer in Delhi',
    'Matrimonial Dispute Lawyer Delhi',
    'Property Dispute Advocate in Delhi',
    'Bail and Anticipatory Bail Lawyer Delhi',
    'Builder-Buyer Dispute Advocate Delhi',
    'Arbitration Lawyer in Delhi NCR',
    'Land Acquisition Lawyer Delhi',
    'Money Recovery Cases in Delhi',
  ];

  // Rotating text state for About section
  const [rotatingIndex, setRotatingIndex] = useState(0);
  const rotatingTimeout = useRef<number | null>(null);
  ...
  useEffect(() => {
    rotatingTimeout.current = window.setTimeout(() => {
  ...
  const scrollToSection = (id: string, service?: string) => {
  ...
  const services = [
    ...
    'Banking Matter',
    'Eviction Suit (landlord/tenant dispute)',
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed">
              Experienced Legal Professional | Delhi High Court | Comprehensive Legal Solutions | Delhi District Courts<br />
            </p>
      ...
      <section id="about" className="py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-800 md:text-lg font-medium max-w-3xl mx-auto">
              Dedicated legal professional committed to delivering exceptional legal services with integrity and expertise.
            </p>
            {/* Rotating Text Animation - one line, black, bold/highlighted */}
            <div className="flex flex-row items-center justify-center mt-4 space-x-2">
              <span className="text-lg md:text-xl font-semibold text-black">Vivek Chandra</span>
              <span className="h-8 md:h-10 text-white text-lg md:text-xl font-extrabold bg-black px-2 rounded transition-all duration-500 ease-in-out animate-fade-in-out">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-2">Professional Background</h3>
                  <p className="text-gray-800 md:text-lg font-medium">
                    Vivek Chandra is a distinguished and accomplished advocate with a proven track record of success before the Delhi High Court, District Courts, and tribunals across the NCR. With years of extensive legal experience, he has earned recognition as a veteran legal professional, respected for his integrity, strategic insight, and commitment to justice. He is a member of the Delhi High Court Bar Association, which further reflects his active involvement and standing within the legal fraternity. Known for his client-focused approach and persuasive advocacy, he has successfully represented individuals, businesses, and NRIs in a wide range of complex legal matters.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-2">Comprehensive Legal Services</h3>
                  <p className="text-gray-800 md:text-lg font-medium">
                    Advocate Vivek Chandra offers a broad spectrum of legal services, tailored to meet the diverse needs of his clients. His areas of expertise include civil and criminal litigation, property disputes, builder and buyer disputes, landlord-tenant issues, arbitration, matrimonial matters, bail and anticipatory bail, recovery of money, cheque bounce cases, and land acquisition matters. He is also skilled in legal drafting, contract vetting, and dispute resolution through negotiation and mediation. Combining deep legal knowledge with practical, result-oriented strategies, he is committed to delivering effective, timely, and client-specific legal solutions.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-2">Client-Focused Approach</h3>
                  <p className="text-gray-800 md:text-lg font-medium">
                    Advocate Vivek Chandra is deeply committed to understanding each client's unique legal situation, priorities, and concerns. He believes that no two cases are alike and tailors his legal strategies to align with the specific needs and goals of every client. His approach is rooted in empathy, transparency, and proactive communication, ensuring that clients are fully informed and involved at every stage of the legal process. Whether it’s a complex litigation or a sensitive personal matter, he delivers personalized, practical, and result-oriented solutions. His unwavering dedication to client satisfaction has earned him the trust and confidence of a diverse clientele, including individuals, professionals, businesses, and NRIs.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-2">Private Practice and Also on Panel of</h3>
                  <ul className="list-disc list-inside text-gray-800 md:text-lg font-medium space-y-2">
                    ...
                    <li>Balances private client needs with responsibilities on these esteemed panel appointments.</li>
                    <li>Draws on experience from both private practice and panel work to deliver comprehensive and effective legal solutions.</li>
                    <li>Committed to offering tailored legal support for each client’s unique circumstances, whether private or panel-referred.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="bg-gray-50 p-12 rounded-3xl shadow-2xl border w-full max-w-3xl mx-auto">
                <h3 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-10">Key Achievements</h3>
                <div className="grid grid-cols-2 gap-10">
                  {achievements.map((achievement, index) => (
                    <div key={index} className="text-center">
                      <div className="text-4xl md:text-5xl font-extrabold text-black mb-3">{achievement.number}</div>
        ...
        {/* Vivek Chandra Photo in white space (desktop only) */}
        <img
          src={vivekchandra}
          alt="Vivek Chandra"
        ...
        />
        {/* pic2.jpg in white space for Private Practice and Also on Panel of (desktop only) */}
        <img
          src={pic2}
          alt="Panel Advocate"
      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <div
                ...
                role="button"
                tabIndex={0}
                onKeyPress={e => { if (e.key === 'Enter' || e.key === ' ') scrollToSection('contact', service); }}
          ...
          <div className="mt-16 bg-black rounded-2xl p-8 text-white text-center">
            ...
            <button
              onClick={() => scrollToSection('contact', 'Other Matter')}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">Delhi Office</h3>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-gray-600">
                    <p className="font-medium text-gray-900 mb-1">Address:</p>
                    <a href="https://www.google.com/maps/search/?api=1&query=Vivek Chandra Advocate, NH-2, Delhi-Mathura Road, Back Side HP petrol pump Mitrol, Near Palwal Court, Palwal, Haryana 121002" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-600">
                      Vivek Chandra Advocate, NH-2, Delhi-Mathura Road, Back Side HP petrol pump Mitrol, Near Palwal Court, Palwal, Haryana 121002
                    </a>
                  </div>
                </div>
              ...
              <form className="space-y-6" onSubmit={handleFormSubmit}>
                ...
                <div>
                  ...
                  >
                    ...
                    {services.concat('Other Matter').map((service) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-4">
              Experienced Legal Professional | Delhi High Court | Comprehensive Legal Solutions | Delhi District Courts
            </p>
